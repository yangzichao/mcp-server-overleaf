...
Most of this is done for you by `npx --yes mcp-server-overleaf@0.3.2 setup`, which verifies
...
Use `npx --yes mcp-server-overleaf@0.3.2 --stdio` and set `OVERLEAF_MCP_ENV_FILE` to an
